    ...
    $scope.shift = function(direction){
        ...
        switch(direction){
            case 'up':
                ...
                newFrame[15] = currFrame[0];
                break;
            case 'down':
                for(var i = 1; i < currFrame.length; i++){
                    newFrame[i] = currFrame[i-1];
                }
                newFrame[0] = currFrame[15];
                break;
            case 'left':
            ...
            if(startChar == 'B'){
                ...
                for (var c = 1; c < line.length; c++) {
                    ...
                    if(charat=='0'||charat=='1') {
                        currFrame[rowCounter][pixelNum] = line.charAt(c) == '1' ? true : false;
                        pixelNum++;
                    }
                }
                rowCounter++;
